...
<h2>1013</h2>
김경빈
- 기능구현 사람 얼굴, 차량 번호판 인식 및 블러 처리<br>
처리 전
<p align = "center">
  <img width = "700" alt="이미지" src = "https://github.com/user-attachments/assets/5e302a33-d8f8-4710-b788-f001403d2f8e">
</p>
처리 후
<p align = "center">
...
<h2>1115</h2>
김명준<br>
- 카카오,구글,네이버 소셜 로그인/회원가입 구현(테스트 완료) <br>
- 게시판 댓글,좋아요 기능 구현(테스트 완료) <br>
- 게시판/댓글 신고 기능 구현(테스트 완료)  <br>
- 사용자 알림 기능 구현(테스트 완료) <br>
